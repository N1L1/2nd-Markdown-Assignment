...
The Philippine Charity Sweepstakes Office (or PCSO for short) runs a variation of the lottery with 6 numbers, all from one to fifty-eight. The rules of the PCSO are simple, if the set of numbers picked by the host matches the numbers on your ticket, you win a prize pool of money! Take note the more winners there are, the more your prize pool is split.
...
This formula will help us find the total number of tickets we need to buy to guarantee a chance at winning the lottery. Inserting our known values into the formula gives us
...
Now I do not know about you, but this feels like a net loss of astronomical scale. 
...
https://www.youtube.com/watch?v=nFz1UX-bZmA
---
